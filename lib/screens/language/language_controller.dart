...
class LanguageController extends GetxController {
  ...
  void onInit() {
    ...
    selectedLanguage = languages.firstWhere((element) => element.languageCode == currentLanguageCode).obs;
    super.onInit();
  }

  setSelectedShippingTypeIndex(String languageCode) {
    selectedLanguage.value = languages.firstWhere((l) => l.languageCode == languageCode);
